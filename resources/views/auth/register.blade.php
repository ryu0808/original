                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">氏名 または 店名 または 保健所名</label>
                        ...
                        <div class="form-group row">
                            <label for="hiragananame" class="col-md-4 col-form-label text-md-right">しめい or てんめい or ほけんじょめい</label>

                            <div class="col-md-6">
                                <input id="hiragananame" type="text" class="form-control @error('hiragananame') is-invalid @enderror" name="hiragananame" value="{{ old('hiragananame') }}" required autocomplete="hiragananame">
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">番地・アパート名（マンション名）・部屋番号</label>
